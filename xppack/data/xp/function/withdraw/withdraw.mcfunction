...
# Give bottle
give @s experience_bottle[custom_data={special:1},custom_model_data={"flags":[true]},custom_name='[{"color":"#EBEB10","text":"3"},{"color":"#E9C910","text":"1"},{"color":"#E8A710","text":"5 "},{"color":"#E68510","text":"X"},{"color":"#E34110","text":"P"}]']
